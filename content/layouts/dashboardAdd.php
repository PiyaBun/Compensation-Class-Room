...
<html lang="en">
  ...
  <body>
      <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">RUS</a>
        <li class="nav-item">
  ...
  <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link" href="?page=indexAdd">
              ข้อมูลการจัดการตารางสอน
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="?page=submit">
              <span data-feather="layers"></span>
              ตรวจสอบยื่นขอสอนชดเชย
            </a>
          </li>
        </ul>
