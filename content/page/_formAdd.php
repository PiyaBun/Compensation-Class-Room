...
<form method="post">
    <div class="form-group">
        ...
        <div class="invalid-feedback">
            <?php if(isset($errors['Su_id'])) { echo $errors['Su_id']; } ?>
        </div>
        ...
        <div class="invalid-feedback">
            <?php if(isset($errors['Gr_id'])) { echo $errors['Gr_id']; } ?>
        </div>
        ...
        <div class="invalid-feedback">
            <?php if(isset($errors['Te_id'])) { echo $errors['Te_id']; } ?>
        </div>
        ...
        <div class="invalid-feedback">
            <?php if(isset($errors['Ro_id'])) { echo $errors['Ro_id']; } ?>
        </div>
